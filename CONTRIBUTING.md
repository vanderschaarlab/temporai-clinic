...
Welcome to `temporai-clinic` contributor's guide.
...
If you experience bugs or general issues with `temporai-clinic`, please have a look
...
You can help improve `temporai-clinic` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`temporai-clinic` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `temporai-clinic`'s files. While this mechanism can
...
```
conda create -n temporai-clinic python=3 six virtualenv pytest pytest-cov
conda activate temporai-clinic
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/temporai-clinic.git
   cd temporai-clinic
   ```
...
5. Install [pre-commit]:
   ...
   `temporai-clinic` comes with a lot of hooks configured to automatically help the
