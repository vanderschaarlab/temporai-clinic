"""A docs building code that must be ran when building TemporAI-Clinic docs.
...
REPO_URL_ROOT = "https://github.com/vanderschaarlab/temporai-clinic/"
...
# Fix images:
convert = {
    r"\"docs/assets/(.*?\..*?)\"": r"'https://raw.githubusercontent.com/vanderschaarlab/temporai-clinic/main/docs/assets/\1'",
    r"\[docs/assets/(.*?\..*?)\]": r"[https://raw.githubusercontent.com/vanderschaarlab/temporai-clinic/main/docs/assets/\1]",
}
